...
class Settings(BaseSettings):
    ...
    som_x: int = Field(default=4, description="Number of SOM neurons in the x-axis.")

    som_y: int = Field(default=4, description="Number of SOM neurons in the y-axis.")

    som_iterations: int = Field(
        default=10000, description="Number of SOM training iterations."
    )

    som_lr: float = Field(default=0.01, description="SOM learning rate.")

    som_sigma: float = Field(default=0.5, description="SOM neighborhood radius.")
